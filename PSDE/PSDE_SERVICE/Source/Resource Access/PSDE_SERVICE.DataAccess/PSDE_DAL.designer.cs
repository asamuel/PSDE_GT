...
namespace PSDE_SERVICE.DataAccess
{
    ...
    partial void DeleteFinca(Finca instance);
		...
		public System.Data.Linq.Table<VistaFincaLista> VistaFincaLista
		{
			get
			{
				return this.GetTable<VistaFincaLista>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.VistaFincaLista")]
	public partial class VistaFincaLista
	{
		...
		public VistaFincaLista()
		{
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IdFinca", DbType="Int NOT NULL")]
		public int IdFinca
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Cliente", DbType="VarChar(60) NOT NULL", CanBeNull=false)]
